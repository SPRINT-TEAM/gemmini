    ...
    , TOP____024unit(Verilated::catName(topp->name(), "$unit"))
{
    ...
    __Vscope_TestHarness__dut__system__subsystem_l2_wrapper__l2__mods_0__abc_mshrs_5.configure(this, name(), "TestHarness.dut.system.subsystem_l2_wrapper.l2.mods_0.abc_mshrs_5", "abc_mshrs_5", -9, VerilatedScope::SCOPE_OTHER);
    __Vscope_TestHarness__dut__system__subsystem_l2_wrapper__l2__mods_0__abc_mshrs_6.configure(this, name(), "TestHarness.dut.system.subsystem_l2_wrapper.l2.mods_0.abc_mshrs_6", "abc_mshrs_6", -9, VerilatedScope::SCOPE_OTHER);
    __Vscope_TestHarness__dut__system__subsystem_l2_wrapper__l2__mods_0__abc_mshrs_7.configure(this, name(), "TestHarness.dut.system.subsystem_l2_wrapper.l2.mods_0.abc_mshrs_7", "abc_mshrs_7", -9, VerilatedScope::SCOPE_OTHER);
    __Vscope_TestHarness__dut__system__subsystem_l2_wrapper__l2__mods_0__abc_mshrs_8.configure(this, name(), "TestHarness.dut.system.subsystem_l2_wrapper.l2.mods_0.abc_mshrs_8", "abc_mshrs_8", -9, VerilatedScope::SCOPE_OTHER);
    __Vscope_TestHarness__dut__system__subsystem_l2_wrapper__l2__mods_0__abc_mshrs_9.configure(this, name(), "TestHarness.dut.system.subsystem_l2_wrapper.l2.mods_0.abc_mshrs_9", "abc_mshrs_9", -9, VerilatedScope::SCOPE_OTHER);
    ...
    __Vscope_TestHarness__dut__system__subsystem_sbus__coupler_from_tile__buffer__TLMonitor_1.configure(this, name(), "TestHarness.dut.system.subsystem_sbus.coupler_from_tile.buffer.TLMonitor_1", "TLMonitor_1", -9, VerilatedScope::SCOPE_OTHER);
    ...
    __Vscope_TestHarness__dut__system__subsystem_sbus__fixer__TLMonitor_2.configure(this, name(), "TestHarness.dut.system.subsystem_sbus.fixer.TLMonitor_2", "TLMonitor_2", -9, VerilatedScope::SCOPE_OTHER);
    ...
    __Vscope_TestHarness__dut__system__subsystem_sbus__system_bus_xbar__TLMonitor_2.configure(this, name(), "TestHarness.dut.system.subsystem_sbus.system_bus_xbar.TLMonitor_2", "TLMonitor_2", -9, VerilatedScope::SCOPE_OTHER);
    __Vscope_TestHarness__dut__system__tile__SimpleHellaCacheIF.configure(this, name(), "TestHarness.dut.system.tile.SimpleHellaCacheIF", "SimpleHellaCacheIF", -9, VerilatedScope::SCOPE_OTHER);
    __Vscope_TestHarness__dut__system__tile__SimpleHellaCacheIF__replayq.configure(this, name(), "TestHarness.dut.system.tile.SimpleHellaCacheIF.replayq", "replayq", -9, VerilatedScope::SCOPE_OTHER);
    ...
    __Vscope_TestHarness__dut__system__tile__buffer__TLMonitor_1.configure(this, name(), "TestHarness.dut.system.tile.buffer.TLMonitor_1", "TLMonitor_1", -9, VerilatedScope::SCOPE_OTHER);
    VTestHarness__Syms_1(topp);
    VTestHarness__Syms_2(topp);
    VTestHarness__Syms_3(topp);
